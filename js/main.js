...
function formStylization() {
  ...
  $(radio)
    .wrap('<div class="new-radio"></div>')
    .closest(".new-radio")
    .append("<span></span>");
  $(checkbox)
    .wrap('<div class="new-checkbox"></div>')
    .closest(".new-checkbox")
    .append(
      '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 13 11" enable-background="new 0 0 13 11" xml:space="preserve"><polyline points="0.2,4.6 1,4 5,9 12,0 12.8,0.6 5.8,9.6 5,10.6 4.2,9.6 0.2,4.6 "/></svg>'
    );
  $(checkbox + ":checked")
    .parent(".new-checkbox")
    .addClass("checked");
  ...
  $("[data-out-animation]").each(function () {
    ...
    if ($this.closest(".section").hasClass("active")) {
      ...
      $this
        ...
        .removeClass(outAnimation)
        .removeAttr("style", "animation-delay");
    }
  });
}
...
function notifyMy() {
  ...
  $(".notify-my .modal-dialog").css(
    "margin-top",
    ($("body").height() - $(".notify-my .modal-dialog").height()) / 2 - margin
  );
}
